...
songs_title = {};
songs_author = {};
var parent = document.getElementById("songUL");
for (var i = 0; i < arr_songs.length; i++) {
	songs[i] = arr_songs[i].replace(".mp3","");
	songs_two = songs[i].split("-");
	songs_author[i] = songs_two[0];
	songs_title[i] = songs_two[1];
//生成歌曲列表--用append
	var li_Obj = document.createElement("li");
	li_Obj.className = "songList" ;
	var div_Obj = document.createElement("div");
	div_Obj.className = "songLMain" ;

	var div_Obj1 = document.createElement("div");
	div_Obj1.className = "check" ;
	div_Obj1.innerHTML = '<input class="checkIn" type="checkbox" select="0">';
	var div_Obj2 = document.createElement("div");
	div_Obj2.className = "start" ;
	var j = i + 1;
	div_Obj2.innerHTML = '<em songurl='+i+'>'+j+'</em>';
	var div_Obj3 = document.createElement("div");
	div_Obj3.className = "songBd" ;
	div_Obj3.innerHTML = '<div class="col colsn">'+songs_title[i]+'</div><div class="col colcn">'+songs_author[i]+'</div><div class="col">我喜欢的</div>';
	var div_Obj4 = document.createElement("div");
	div_Obj4.className = "control" ;
	div_Obj4.innerHTML = '<a class="cicon love"></a><a class="cicon more" style="display:none"></a><a class="cicon dele" style="display:none"></a>';
	div_Obj.appendChild(div_Obj1);
	div_Obj.appendChild(div_Obj2);
	div_Obj.appendChild(div_Obj3);
	div_Obj.appendChild(div_Obj4);
	li_Obj.appendChild(div_Obj);
	parent.appendChild(li_Obj);
}
...
$(function(){
	...
	$(".start em").click(function(){
		/*开始放歌*/
		var sid=$(this).attr("songurl");
		songIndex=sid;
		$("#audio").attr("src",'songs/'+songs[sid]+'.mp3');
...
function fPlay(){
	$(".start em[songurl="+songIndex+"]").click();
}
//遍历文件下下的音乐
